...
function ponerQuitarFavorito(numero) {

  const index = listaFav.value.indexOf(numero);

  if (index === -1) {
    listaFav.value.push(numero);
  } else {
    listaFav.value.splice(index, 1);
  }


  console.log(listaFav.value);
}

function quitarFav(numero){
  console.log(numero);
  listaFav.value.splice(numero,1);
  console.log(listaFav.value);
}
...
<template>
    ...
    <div v-if="bool" class="container text-center">
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
            <div class="col-3" v-for="item in lista">
                <div class="card" style="margin-bottom: 5%;">
                    <div class="content">
                        ...
                        <div class="front-content">
                            <small class="badge">{{ item.id }}</small>
                            <div class="description">
                            <div class="title">
                            <strong>{{ item.title }}</strong>
                            </div>
                            <label @click="ponerQuitarFavorito(item.id)" class="switch">
            ...
            <div class="col" v-for="(index,item) in listaFav" :key="item">
                <div class="card" style="margin-bottom: 5%;">
                    <div class="content">
                        ...
                        <div class="front-content">
                            <small class="badge">{{ index }}</small>
                            <div class="description">
                            <div class="title">
                            <strong>{{ item.title }}</strong>
                            </div>
                            <label @click="quitarFav(item)" class="switch">
                                <input @click.stop type="checkbox">
                                <span class="slider"></span>
                            </label>
                        </div>
